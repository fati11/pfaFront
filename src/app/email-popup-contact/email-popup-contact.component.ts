...
@Component({
  selector: 'app-email-popup-contact',
  templateUrl: './email-popup-contact.component.html',
  styleUrls: ['./email-popup-contact.component.css']
})
export class EmailPopupContactComponent implements OnInit {
